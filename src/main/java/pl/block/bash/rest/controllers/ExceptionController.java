...
import pl.block.bash.rest.model.BusinessExceptionModel;
...
public class ExceptionController {
    ...
    private static final String ERROR_MESSAGE = "An error occurred during request processing. Please contact with developers.";
